            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                */ ?>
                <div class="entry-content">
                  <?php
                      if (is_page('2') || is_page('Home')) {
                        // ?>
                        // <div class="center-image">
                        //   <a href="designers"><img class="delay indexIMG" src="<?php bloginfo('template_url'); ?>/img/first-Page.jpg" alt=""></a>
                        // </div>
                        // <script>
                        //   $(function(){
                        //   $('#overlay').hide();
                        //   $('.indexIMG').fadeIn(8000).delay(120000,function(){
                        //   });
                        //   })
                        // </script>
                        //
                        ...
                        //   $(this).fadeTo(200, 0.8).fadeTo(100, 1);
                        //   });
                        // </script>
                        // <?php
                      }
