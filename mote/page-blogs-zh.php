	...
	<main id="main" class="site-main" role="main">
		...
		$posts_array = get_posts( $args );
			...
			foreach($posts_array as $post_blog) :
				...
				$desc = (strlen($post_blog->post_content) > 250) ? substr($post_blog->post_content,0,250).'...' : $post_blog->post_content;
						?>
						<div class="row">
							...
							<div class="small-12 medium-8 large-8 columns blog-text text-left">
								<!-- <h2><?=the_date()?><h2> -->
